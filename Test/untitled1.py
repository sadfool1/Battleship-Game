...
def redraw_boards():
    ...
    Label(root, text="Player Underwater", height = 3, width = 15).grid(row=0, column=0, columnspan=10)
    Label(root, text="Player Surface", height = 3, width = 15).grid(row=0, column=12, columnspan=10)

    # Preparing spacings between the grids
    Label(root, text="", height = 20, width = 4).grid(row=1, column=10, rowspan=10)
    Label(root, text="AI Underwater", height = 3, width = 15).grid(row=11, column=0, columnspan=10)
    Label(root, text="AI Surface", height = 3, width = 15).grid(row=11, column=11, columnspan=10)
    ...
    for i in range(12, 22):
        ...
        for j in range(10):
            ...
            AI_underwater_cell = Button(root, 
    ...
    for i in range(1, 11):
        ...
        for j in range(10):
            ...
            player_underwater_cell = Button(root, 
                                            height = button_height, 
                                            width = button_width, 
    ...
    for i in range(1, 11):
        ...
        for j in range(11, 21):
            ...
            player_surface_cell = Button(root, 
                                         height = button_height, 
                                         width = button_width, 
                                         command=cannot_shoot,
    ...
    for i in range(len(Player["Carrier"])):
        player_ship_location = Button(root,
                                      height = button_height, 
                                      width = button_width, 
                                      command=cannot_shoot,
    ...
    print (redraw_gameboard.grid_size())
...
def draw_new_button_hit(row, column):
    ...
    new_button.grid(row = row, column = column, in_ = root)
